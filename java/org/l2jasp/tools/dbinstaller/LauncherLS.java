 ...
 */
package org.l2jasp.tools.dbinstaller;
...
import org.l2jasp.tools.dbinstaller.console.DBInstallerConsole;
import org.l2jasp.tools.dbinstaller.gui.DBConfigGUI;
...
public class LauncherLS extends AbstractDBLauncher
{
	public static void main(String[] args) throws Exception
	{
		...
		final String defDatabase = "l2jAspc6";

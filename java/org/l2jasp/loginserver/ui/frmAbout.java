...
public class frmAbout
{
	...
	private static final String URL = "www.l2jAsp.org";
	final URI uri;
	...
	private void initialize()
	{
		...
		final JLabel lblLjAsp = new JLabel("L2jAsp");
		lblLjAsp.setFont(new Font("Tahoma", Font.PLAIN, 32));
		lblLjAsp.setHorizontalAlignment(SwingConstants.CENTER);
		lblLjAsp.setBounds(10, 11, 271, 39);
		frmAbout.getContentPane().add(lblLjAsp);

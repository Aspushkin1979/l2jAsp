 ...
 */
package org.l2jasp.loginserver.ui;
...
import org.l2jasp.commons.ui.DarkTheme;
import org.l2jasp.commons.ui.LimitLinesDocumentListener;
import org.l2jasp.commons.ui.SplashScreen;
import org.l2jasp.loginserver.GameServerTable;
import org.l2jasp.loginserver.GameServerTable.GameServerInfo;
...
public class Gui
{
	...
	public Gui()
	{
		...
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "l2jAsp_16x16.png").getImage());
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "l2jAsp_32x32.png").getImage());
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "l2jAsp_64x64.png").getImage());
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "l2jAsp_128x128.png").getImage());
		
		final JScrollPane scrollPanel = new JScrollPane(txtrConsole);
		scrollPanel.setBounds(0, 0, 800, 550);
		
		// Set frame.
		final JFrame frame = new JFrame("Asp - LoginServer");

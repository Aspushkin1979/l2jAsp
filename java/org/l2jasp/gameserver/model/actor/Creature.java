...
import static org.l2jasp.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
...
import org.l2jasp.gameserver.ai.AttackableAI;
...
import org.l2jasp.gameserver.data.xml.DoorData;
import org.l2jasp.gameserver.data.xml.FenceData;
...
import org.l2jasp.gameserver.geoengine.pathfinding.AbstractNodeLoc;
import org.l2jasp.gameserver.geoengine.pathfinding.PathFinding;
import org.l2jasp.gameserver.handler.ISkillHandler;
import org.l2jasp.gameserver.handler.SkillHandler;
import org.l2jasp.gameserver.handler.itemhandlers.Potions;
...
import org.l2jasp.gameserver.model.ForceBuff;
...
import org.l2jasp.gameserver.model.actor.instance.ControlTower;
...
import org.l2jasp.gameserver.model.actor.instance.Minion;
import org.l2jasp.gameserver.model.actor.instance.Monster;
import org.l2jasp.gameserver.model.actor.instance.NpcWalker;
import org.l2jasp.gameserver.model.actor.instance.Pet;
import org.l2jasp.gameserver.model.actor.instance.RaidBoss;
import org.l2jasp.gameserver.model.actor.instance.RiftInvader;
import org.l2jasp.gameserver.model.actor.instance.Servitor;
import org.l2jasp.gameserver.model.actor.instance.SiegeFlag;
import org.l2jasp.gameserver.model.actor.knownlist.CreatureKnownList;
import org.l2jasp.gameserver.model.actor.stat.CreatureStat;
import org.l2jasp.gameserver.model.actor.status.CreatureStatus;
import org.l2jasp.gameserver.model.actor.templates.CreatureTemplate;
...
import org.l2jasp.gameserver.model.skill.Calculator;
import org.l2jasp.gameserver.model.skill.ChanceSkillList;
...
import org.l2jasp.gameserver.model.skill.funcs.Func;
import org.l2jasp.gameserver.model.skill.holders.ISkillsHolder;
import org.l2jasp.gameserver.model.zone.ZoneId;
import org.l2jasp.gameserver.model.zone.type.BossZone;
import org.l2jasp.gameserver.network.SystemMessageId;
import org.l2jasp.gameserver.network.serverpackets.ActionFailed;
import org.l2jasp.gameserver.network.serverpackets.Attack;
import org.l2jasp.gameserver.network.serverpackets.ChangeMoveType;
import org.l2jasp.gameserver.network.serverpackets.ChangeWaitType;
import org.l2jasp.gameserver.network.serverpackets.ExOlympiadSpelledInfo;
import org.l2jasp.gameserver.network.serverpackets.MagicEffectIcons;
import org.l2jasp.gameserver.network.serverpackets.MagicSkillCanceled;
import org.l2jasp.gameserver.network.serverpackets.MagicSkillLaunched;
import org.l2jasp.gameserver.network.serverpackets.MagicSkillUse;
import org.l2jasp.gameserver.network.serverpackets.MoveToLocation;
...
import org.l2jasp.gameserver.network.serverpackets.PartySpelled;
import org.l2jasp.gameserver.network.serverpackets.PetInfo;
import org.l2jasp.gameserver.network.serverpackets.Revive;
...
import org.l2jasp.gameserver.network.serverpackets.TargetUnselected;
import org.l2jasp.gameserver.network.serverpackets.TeleportToLocation;
import org.l2jasp.gameserver.network.serverpackets.ValidateLocationInVehicle;
import org.l2jasp.gameserver.taskmanager.GameTimeTaskManager;
import org.l2jasp.gameserver.taskmanager.MovementTaskManager;
...
public abstract class Creature extends WorldObject implements ISkillsHolder
{
	...
	protected void doAttack(Creature target)
	{
		...
		// Asp: Do not move when attack is launched.
		if (isMoving())
		{
	...
	protected void moveToLocation(int xValue, int yValue, int zValue, int offsetValue)
	{
		...
		// Asp: Fix for teleporting on top of catacomb entrances.

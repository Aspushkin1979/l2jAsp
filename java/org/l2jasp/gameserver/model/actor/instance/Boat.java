...
import org.l2jasp.gameserver.model.actor.knownlist.BoatKnownList;
import org.l2jasp.gameserver.model.actor.templates.CreatureTemplate;
import org.l2jasp.gameserver.model.holders.BoatPathHolder;
import org.l2jasp.gameserver.model.holders.BoatPathHolder.BoatPoint;
...
import org.l2jasp.gameserver.network.serverpackets.OnVehicleCheckLocation;
import org.l2jasp.gameserver.network.serverpackets.PlaySound;
import org.l2jasp.gameserver.network.serverpackets.VehicleDeparture;
		...
		switch (id)
		{
			case 10:
			{
				...
				for (Player player : knownPlayers)
				{
					...
					// Asp: Fixes weird movement at the end of the path.

...
/**
 * The Class CastleTeleporter.
 * @author Kerberos
 */
public class CastleTeleporter extends Npc
{
	public static final Logger LOGGER = Logger.getLogger(CastleTeleporter.class.getName());
	 ...
	 */
	public CastleTeleporter(int objectId, NpcTemplate template)
	{

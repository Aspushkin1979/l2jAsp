 ...
 */
package org.l2jasp.gameserver.model.actor;
...
import org.l2jasp.gameserver.LoginServerThread;
import org.l2jasp.gameserver.ai.CreatureAI;
import org.l2jasp.gameserver.ai.CtrlIntention;
import org.l2jasp.gameserver.ai.PlayerAI;
import org.l2jasp.gameserver.cache.HtmCache;
import org.l2jasp.gameserver.communitybbs.BB.Forum;
import org.l2jasp.gameserver.communitybbs.Manager.ForumsBBSManager;
import org.l2jasp.gameserver.data.HeroSkillTable;
import org.l2jasp.gameserver.data.ItemTable;
import org.l2jasp.gameserver.data.NobleSkillTable;
import org.l2jasp.gameserver.data.SkillTable;
import org.l2jasp.gameserver.data.sql.AnnouncementsTable;
...
import org.l2jasp.gameserver.data.xml.ExperienceData;
import org.l2jasp.gameserver.data.xml.FishData;
...
import org.l2jasp.gameserver.data.xml.RecipeData;
...
import org.l2jasp.gameserver.geoengine.GeoEngine;
import org.l2jasp.gameserver.handler.IItemHandler;
import org.l2jasp.gameserver.handler.ItemHandler;
import org.l2jasp.gameserver.handler.admincommandhandlers.AdminEditChar;
import org.l2jasp.gameserver.handler.skillhandlers.SiegeFlag;
import org.l2jasp.gameserver.handler.skillhandlers.StrSiegeAssault;
import org.l2jasp.gameserver.handler.skillhandlers.TakeCastle;
import org.l2jasp.gameserver.instancemanager.CastleManager;
import org.l2jasp.gameserver.instancemanager.CoupleManager;
import org.l2jasp.gameserver.instancemanager.CursedWeaponsManager;
import org.l2jasp.gameserver.instancemanager.DimensionalRiftManager;
import org.l2jasp.gameserver.instancemanager.DuelManager;
import org.l2jasp.gameserver.instancemanager.FortSiegeManager;
...
import org.l2jasp.gameserver.instancemanager.RebirthManager;
import org.l2jasp.gameserver.instancemanager.RecipeManager;
import org.l2jasp.gameserver.instancemanager.SiegeManager;
import org.l2jasp.gameserver.model.AccessLevel;
import org.l2jasp.gameserver.model.BlockList;
import org.l2jasp.gameserver.model.Duel;
import org.l2jasp.gameserver.model.Fish;
import org.l2jasp.gameserver.model.Fishing;
import org.l2jasp.gameserver.model.Location;
import org.l2jasp.gameserver.model.Macro;
import org.l2jasp.gameserver.model.MacroList;
import org.l2jasp.gameserver.model.ManufactureList;
import org.l2jasp.gameserver.model.Party;
import org.l2jasp.gameserver.model.Radar;
import org.l2jasp.gameserver.model.RecipeList;
import org.l2jasp.gameserver.model.Request;
import org.l2jasp.gameserver.model.ShortCut;
import org.l2jasp.gameserver.model.ShortCuts;
import org.l2jasp.gameserver.model.Skill;
import org.l2jasp.gameserver.model.SkillLearn;
import org.l2jasp.gameserver.model.SubClass;
import org.l2jasp.gameserver.model.Timestamp;
...
import org.l2jasp.gameserver.model.WorldRegion;
import org.l2jasp.gameserver.model.actor.appearance.PlayerAppearance;
import org.l2jasp.gameserver.model.actor.instance.Boat;
import org.l2jasp.gameserver.model.actor.instance.Cubic;
import org.l2jasp.gameserver.model.actor.instance.Door;
import org.l2jasp.gameserver.model.actor.instance.FestivalMonster;
import org.l2jasp.gameserver.model.actor.instance.Folk;
import org.l2jasp.gameserver.model.actor.instance.FortSiegeGuard;
import org.l2jasp.gameserver.model.actor.instance.GrandBoss;
import org.l2jasp.gameserver.model.actor.instance.Guard;
import org.l2jasp.gameserver.model.actor.instance.Monster;
import org.l2jasp.gameserver.model.actor.instance.RaidBoss;
import org.l2jasp.gameserver.model.actor.instance.Servitor;
import org.l2jasp.gameserver.model.actor.instance.SiegeGuard;
import org.l2jasp.gameserver.model.actor.instance.TamedBeast;
import org.l2jasp.gameserver.model.actor.knownlist.PlayerKnownList;
import org.l2jasp.gameserver.model.actor.stat.PlayerStat;
import org.l2jasp.gameserver.model.actor.status.PlayerStatus;
...
import org.l2jasp.gameserver.model.holders.AutoPlaySettingsHolder;
import org.l2jasp.gameserver.model.holders.AutoUseSettingsHolder;
import org.l2jasp.gameserver.model.holders.ItemHolder;
import org.l2jasp.gameserver.model.holders.PlayerStatsHolder;
import org.l2jasp.gameserver.model.holders.SkillUseHolder;
import org.l2jasp.gameserver.model.holders.SummonRequestHolder;
import org.l2jasp.gameserver.model.item.Armor;
...
import org.l2jasp.gameserver.model.itemcontainer.PetInventory;
import org.l2jasp.gameserver.model.itemcontainer.PlayerFreight;
...
import org.l2jasp.gameserver.model.sevensigns.SevenSignsFestival;
import org.l2jasp.gameserver.model.siege.Castle;
import org.l2jasp.gameserver.model.siege.FortSiege;
import org.l2jasp.gameserver.model.siege.Siege;
import org.l2jasp.gameserver.model.siege.clanhalls.DevastatedCastle;
import org.l2jasp.gameserver.model.skill.BaseStat;
import org.l2jasp.gameserver.model.skill.Formulas;
...
import org.l2jasp.gameserver.model.skill.effects.EffectCharge;
import org.l2jasp.gameserver.model.skill.handlers.SkillSummon;
import org.l2jasp.gameserver.model.variables.AccountVariables;
import org.l2jasp.gameserver.model.variables.PlayerVariables;
import org.l2jasp.gameserver.model.zone.ZoneId;
import org.l2jasp.gameserver.model.zone.type.WaterZone;
...
import org.l2jasp.gameserver.network.serverpackets.ChangeWaitType;
...
import org.l2jasp.gameserver.network.serverpackets.EtcStatusUpdate;
import org.l2jasp.gameserver.network.serverpackets.ExAutoSoulShot;
import org.l2jasp.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import org.l2jasp.gameserver.network.serverpackets.ExFishingEnd;
import org.l2jasp.gameserver.network.serverpackets.ExFishingStart;
import org.l2jasp.gameserver.network.serverpackets.ExOlympiadMode;
import org.l2jasp.gameserver.network.serverpackets.ExOlympiadUserInfo;
import org.l2jasp.gameserver.network.serverpackets.ExPCCafePointInfo;
import org.l2jasp.gameserver.network.serverpackets.ExSetCompassZoneCode;
import org.l2jasp.gameserver.network.serverpackets.FriendList;
import org.l2jasp.gameserver.network.serverpackets.HennaInfo;
...
import org.l2jasp.gameserver.network.serverpackets.MagicSkillCanceled;
import org.l2jasp.gameserver.network.serverpackets.MyTargetSelected;
import org.l2jasp.gameserver.network.serverpackets.NpcHtmlMessage;
import org.l2jasp.gameserver.network.serverpackets.NpcInfo;
import org.l2jasp.gameserver.network.serverpackets.ObservationMode;
import org.l2jasp.gameserver.network.serverpackets.ObservationReturn;
import org.l2jasp.gameserver.network.serverpackets.PartySmallWindowUpdate;
import org.l2jasp.gameserver.network.serverpackets.PetInventoryUpdate;
...
import org.l2jasp.gameserver.network.serverpackets.PrivateStoreListBuy;
import org.l2jasp.gameserver.network.serverpackets.PrivateStoreListSell;
import org.l2jasp.gameserver.network.serverpackets.QuestList;
import org.l2jasp.gameserver.network.serverpackets.RecipeShopSellList;
import org.l2jasp.gameserver.network.serverpackets.RelationChanged;
import org.l2jasp.gameserver.network.serverpackets.Ride;
...
import org.l2jasp.gameserver.network.serverpackets.ShortBuffStatusUpdate;
import org.l2jasp.gameserver.network.serverpackets.ShortCutInit;
import org.l2jasp.gameserver.network.serverpackets.ShortCutRegister;
import org.l2jasp.gameserver.network.serverpackets.SkillCoolTime;
import org.l2jasp.gameserver.network.serverpackets.SkillList;
import org.l2jasp.gameserver.network.serverpackets.Snoop;
...
import org.l2jasp.gameserver.network.serverpackets.StopMove;
import org.l2jasp.gameserver.network.serverpackets.SystemMessage;
import org.l2jasp.gameserver.network.serverpackets.TargetSelected;
import org.l2jasp.gameserver.network.serverpackets.TitleUpdate;
import org.l2jasp.gameserver.network.serverpackets.TradePressOtherOk;
import org.l2jasp.gameserver.network.serverpackets.TradePressOwnOk;
import org.l2jasp.gameserver.network.serverpackets.TradeStart;
import org.l2jasp.gameserver.network.serverpackets.UserInfo;
import org.l2jasp.gameserver.network.serverpackets.ValidateLocation;
import org.l2jasp.gameserver.taskmanager.AutoPlayTaskManager;
import org.l2jasp.gameserver.taskmanager.AutoUseTaskManager;
import org.l2jasp.gameserver.taskmanager.GameTimeTaskManager;
import org.l2jasp.gameserver.taskmanager.ItemsAutoDestroyTaskManager;
import org.l2jasp.gameserver.taskmanager.PlayerAutoSaveTaskManager;
import org.l2jasp.gameserver.taskmanager.PvpFlagTaskManager;
...
public class Player extends Playable
{
	...
	protected boolean checkAndEquipArrows()
	{
		...
		if ((getInventory().getPaperdollItem(Inventory.PAPERDOLL_LHAND) == null) //
			// Asp: Fix for pickup/equip arrows on dual weapons.

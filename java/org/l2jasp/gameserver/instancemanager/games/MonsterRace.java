 ...
 */
package org.l2jasp.gameserver.instancemanager.games;
...
import org.l2jasp.gameserver.network.serverpackets.MonRaceInfo;
	...
	public void newRace()
	{
		...
		for (int i = 0; i < 8; i++)
		{
			try
			{
				...
				_constructor = Class.forName("org.l2jasp.gameserver.model.actor.instance." + template.getType()).getConstructors()[0];

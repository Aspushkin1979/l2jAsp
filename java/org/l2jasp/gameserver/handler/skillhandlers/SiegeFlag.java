...
public class SiegeFlag implements ISkillHandler
{
	...
	public void useSkill(Creature creature, Skill skill, List<Creature> targets)
	{
		...
		{
			// Spawn a new flag.
			final org.l2jasp.gameserver.model.actor.instance.SiegeFlag flag = new org.l2jasp.gameserver.model.actor.instance.SiegeFlag(player, IdManager.getInstance().getNextId(), NpcTable.getInstance().getTemplate(35062));

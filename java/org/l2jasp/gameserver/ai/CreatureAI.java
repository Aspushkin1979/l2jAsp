 ...
 */
package org.l2jasp.gameserver.ai;

import static org.l2jasp.gameserver.ai.CtrlIntention.AI_INTENTION_ACTIVE;
import static org.l2jasp.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
import static org.l2jasp.gameserver.ai.CtrlIntention.AI_INTENTION_CAST;
import static org.l2jasp.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
import static org.l2jasp.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE;
import static org.l2jasp.gameserver.ai.CtrlIntention.AI_INTENTION_INTERACT;
import static org.l2jasp.gameserver.ai.CtrlIntention.AI_INTENTION_MOVE_TO;
import static org.l2jasp.gameserver.ai.CtrlIntention.AI_INTENTION_PICK_UP;
import static org.l2jasp.gameserver.ai.CtrlIntention.AI_INTENTION_REST;

import org.l2jasp.gameserver.ai.PlayerAI.IntentionCommand;
...
import org.l2jasp.gameserver.network.serverpackets.AutoAttackStop;
import org.l2jasp.gameserver.taskmanager.AttackStanceTaskManager;
...
public class CreatureAI extends AbstractAI
{
	...
	/*
	 * (non-Javadoc)
	 * @see org.l2jasp.gameserver.ai.AbstractAI#onIntentionMoveToInABoat(org.l2jasp.gameserver.model.Location, org.l2jasp.gameserver.model.Location)
	 */
	@Override
	...
	/**
	 * @see org.l2jasp.gameserver.ai.AbstractAI#onIntentionActive()
	 */
	@Override

...
import static org.l2jasp.gameserver.taskmanager.TaskTypes.TYPE_FIXED_SHEDULED;
import static org.l2jasp.gameserver.taskmanager.TaskTypes.TYPE_GLOBAL_TASK;
import static org.l2jasp.gameserver.taskmanager.TaskTypes.TYPE_NONE;
import static org.l2jasp.gameserver.taskmanager.TaskTypes.TYPE_SHEDULED;
import static org.l2jasp.gameserver.taskmanager.TaskTypes.TYPE_SPECIAL;
import static org.l2jasp.gameserver.taskmanager.TaskTypes.TYPE_STARTUP;
import static org.l2jasp.gameserver.taskmanager.TaskTypes.TYPE_TIME;
...
import org.l2jasp.gameserver.taskmanager.tasks.TaskCleanUp;
import org.l2jasp.gameserver.taskmanager.tasks.TaskOlympiadSave;
import org.l2jasp.gameserver.taskmanager.tasks.TaskRaidPointsReset;
import org.l2jasp.gameserver.taskmanager.tasks.TaskRecom;
import org.l2jasp.gameserver.taskmanager.tasks.TaskRestart;
import org.l2jasp.gameserver.taskmanager.tasks.TaskSevenSignsUpdate;
import org.l2jasp.gameserver.taskmanager.tasks.TaskShutdown;

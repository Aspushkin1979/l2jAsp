...
import org.l2jasp.gameserver.enums.PlayerState;
...
import org.l2jasp.gameserver.model.skill.conditions.Condition;
import org.l2jasp.gameserver.model.skill.conditions.ConditionElementSeed;
import org.l2jasp.gameserver.model.skill.conditions.ConditionForceBuff;
import org.l2jasp.gameserver.model.skill.conditions.ConditionGameChance;
import org.l2jasp.gameserver.model.skill.conditions.ConditionGameTime;
import org.l2jasp.gameserver.model.skill.conditions.ConditionLogicAnd;
import org.l2jasp.gameserver.model.skill.conditions.ConditionLogicNot;
import org.l2jasp.gameserver.model.skill.conditions.ConditionLogicOr;
import org.l2jasp.gameserver.model.skill.conditions.ConditionPlayerClassIdRestriction;
import org.l2jasp.gameserver.model.skill.conditions.ConditionPlayerHp;
import org.l2jasp.gameserver.model.skill.conditions.ConditionPlayerHpPercentage;
import org.l2jasp.gameserver.model.skill.conditions.ConditionPlayerLevel;
import org.l2jasp.gameserver.model.skill.conditions.ConditionPlayerMp;
import org.l2jasp.gameserver.model.skill.conditions.ConditionPlayerRace;
import org.l2jasp.gameserver.model.skill.conditions.ConditionPlayerState;
import org.l2jasp.gameserver.model.skill.conditions.ConditionSkillStats;
import org.l2jasp.gameserver.model.skill.conditions.ConditionSlotItemId;
import org.l2jasp.gameserver.model.skill.conditions.ConditionTargetAggro;
import org.l2jasp.gameserver.model.skill.conditions.ConditionTargetClassIdRestriction;
import org.l2jasp.gameserver.model.skill.conditions.ConditionTargetLevel;
import org.l2jasp.gameserver.model.skill.conditions.ConditionTargetRaceId;
import org.l2jasp.gameserver.model.skill.conditions.ConditionTargetUsesWeaponKind;
import org.l2jasp.gameserver.model.skill.conditions.ConditionUsingItemType;
import org.l2jasp.gameserver.model.skill.conditions.ConditionUsingSkill;
import org.l2jasp.gameserver.model.skill.conditions.ConditionWithSkill;
import org.l2jasp.gameserver.model.skill.effects.EffectTemplate;
import org.l2jasp.gameserver.model.skill.funcs.FuncTemplate;
import org.l2jasp.gameserver.model.skill.funcs.Lambda;
import org.l2jasp.gameserver.model.skill.funcs.LambdaCalc;
import org.l2jasp.gameserver.model.skill.funcs.LambdaConst;
import org.l2jasp.gameserver.model.skill.funcs.LambdaStats;
import org.l2jasp.gameserver.model.skill.funcs.LambdaStatType;

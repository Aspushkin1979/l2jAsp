...
'Run the installer.
shell.Run "cmd /c start ""L2J Asp - Register Game Server"" " & path & "java -Djava.util.logging.config.file=console.cfg -cp ./../libs/* org.l2jasp.tools.gsregistering.BaseGameServerRegister -c", 1, False
